...
from transport.models import Language, Company
...
class Account(AbstractBaseUser):
    ...
    phone_number = models.CharField(max_length=30, blank=True, null=True, default=None, unique=True)
    ...
    panes = models.JSONField(blank=True, null=True, default=None)
